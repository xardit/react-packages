...
const ScrollContainer = ({ children }) => {
  ...
  const scrollYmotionValue = useMotionValue(-window.pageYOffset || -window.scrollY)
  ...
  useLayoutEffect(() => {
    ...
    let resizeObserver = new ResizeObserver((entries) => getContentHeight(entries))
  ...
  return (
    <>
      <motion.div ref={scrollContainerRef} style={{ y: scrollYspring }} className='scroll-container'>
        {children}
      </motion.div>
